...
def login_gate() -> None:
    configured_username = get_secret_value("auth", "username") or os.getenv("APP_USERNAME", "").strip()
    configured_password = get_secret_value("auth", "password") or os.getenv("APP_PASSWORD", "").strip()
    auth_required = bool(configured_username and configured_password)
    ...
    with st.form("login_form"):
        ...
        if submitted:
            valid_user = hmac.compare_digest(username, configured_username)
